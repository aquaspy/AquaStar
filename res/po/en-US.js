...
exports.settingsMessages = {
    ...
    ruffleDownloadedLabel  : "Downloaded nightly",
    ruffleBundledLabel     : "Bundled fallback",
    ruffleUpdateLabel      : "Ruffle Nightly",
    ruffleUpdateHint       : "Downloads Ruffle's self-hosted web build from its official GitHub nightly release. Restart to apply it.",
    ruffleUpdateButton     : "Download Update",
    ruffleDownloadingMessage: "Downloading Ruffle nightly...",
    ruffleUpdatedMessage   : "Ruffle nightly downloaded. Restart AquaStar to apply it.",
...
exports.remindersMessages = {
    ...
    showMemberDailiesLabel: "Show member dailies",
