...
(function (root, factory) {
  ...
  const DEFAULT_AQW_SEASONAL_KEYS = [
  ...
  function createListState(config) {
    const SEASONAL_EVENT_KEYS = (config && Array.isArray(config.seasonalEventKeys))
      ? config.seasonalEventKeys.slice()
      : DEFAULT_AQW_SEASONAL_KEYS.slice();
  ...
  const defaultApi = createListState();
