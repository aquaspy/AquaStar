...
contextBridge.exposeInMainWorld("aquastarSettings", {
  ...
  updateRuffle:     (channel) => ipcRenderer.invoke("updateRuffle", channel),
  getRuffleStatus:  () => ipcRenderer.invoke("getRuffleStatus"),
  restoreBundledRuffle: () => ipcRenderer.invoke("restoreBundledRuffle"),
