...
const bundledStudioSwfPath = path.join(__dirname, 'characterB-studio.swf');
...
ipcMain.handle('charpage-studio-capture', async (event, bounds) => {
    ...
    const savedPath = await require('../../../../res/instances.js').takeSS(win, captureBounds(bounds, win));
